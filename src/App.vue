...
<head>
  ...
  <main>
    ...
    <br>
    <div class = "buttons">
      <button v-on:click="displayEncryption(keyExpantion(key))" type="button" class="btn btn-dark">Зашифровать</button>
      <button v-on:click="displayDecryption()" type="button" class="btn btn-dark ">Расшифровать</button>
    </div>
    <p style="white-space: pre-line;">{{ message }}</p>
