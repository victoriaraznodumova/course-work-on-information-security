...
<head>
  ...
  <main>
    ...
    <textarea id="key-textarea" rows="7" cols="38" v-model="message" placeholder="Введите ключ"></textarea>
    <p style="white-space: pre-line;">{{ message }}</p>
    <textarea id="encrypt-textarea" rows="7" cols="38" v-model="message" placeholder="Введите текст для шифрования"></textarea>
    <br>
    <div class = "buttons">
      <button v-on:click="displayText()" type="button" class="btn btn-dark">Зашифровать</button>
...
function displayText() {
  ...
  document.getElementById("decrypt-textarea").value = text;
}
</script>
