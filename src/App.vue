...
<head>
  ...
  <main>
    ...
    <br>
    <div class = "buttons">
      <button v-on:click="displayEncryption(Encryption2())" type="button" class="btn btn-dark">Зашифровать</button>
...
export default {
    ...
    methods: {
      ...
      keyExpantion(key){
          ...
          function expandKey(initialKey) {
            ...
            return expandedKey.toString(16);
          }
  ...
  //43, 126, 15, 16, 77, 189, 139, 99
          ...
          //first mash round
          const R_58_encryption_3 = mash_encryption(R_58_encryption_2, key);
          ...
          //second mash round
          const R_14_encryption_7 = mash_encryption(R_14_encryption_6, key);
